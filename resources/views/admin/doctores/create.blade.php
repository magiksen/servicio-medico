                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Agregar Doctor</h4>
                            ...
                            <form class="form-horizontal mt-3" action="{{ route('doctores.store') }}" method="post">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-5">
                                        <input class="form-control" type="text" id="clinica" name="clinica" value="{{ old('clinica') }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
